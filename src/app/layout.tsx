...
export const metadata: Metadata = {
  title: "ComputeClub - Exclusive Tech Community & Networking",  description: "Join ComputeClub, a private community for computer professionals, developers, and tech innovators. Access exclusive workshops, networking events, and collaborate on innovative projects.",  keywords: "tech community, computer club, networking, developers, innovation, workshops, professional network",  metadataBase: new URL("https://computeclub.com"),
  alternates: {
    canonical: "https://computeclub.com"},
  openGraph: {
    title: "ComputeClub - Connect with Tech Professionals",    description: "Join an exclusive community dedicated to technology innovation and professional growth.",    url: "https://computeclub.com",    siteName: "ComputeClub",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/business-graphs-performance-metrics-monitors-office_482257-126569.jpg",        alt: "ComputeClub Community"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "ComputeClub - Tech Community",    description: "Connect, collaborate, and grow with tech professionals worldwide.",    images: ["http://img.b2bpic.net/free-photo/business-graphs-performance-metrics-monitors-office_482257-126569.jpg"],
  },
  robots: {
    index: true,
    follow: true,
